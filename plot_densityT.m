function plot_densityT(x,y,xname,yname,flabel,sitename)
...
str9=strcat('>EE:',str9,'%');
xlabel(xname,'Fontname','微软雅黑','FontSize',21,'FontWeight','bold');
ylabel(yname,'Fontname','微软雅黑','FontSize',21,'FontWeight','bold');
strtime=sitename;
%text(2.8,0.15,'(a)','FontSize',25,'Fontname','Cambria')
%text(700,40,'(d)','FontSize',30,'Fontname','Cambria')
text(t1,t2,str1,'FontSize',22,'Fontname','Cambria');
text(t1,t3,str2,'FontSize',22,'Fontname','Cambria');
text(t1,t4,str3,'FontSize',22,'Fontname','Cambria');
 text(1.2,t2,strtime,'FontSize',25,'Fontname','Cambria')
%text(t1,t5,str4,'FontSize',22,'Fontname','Cambria');
text(t1,t5,str5,'FontSize',22,'Fontname','Cambria');
%text(t1,t7,str6,'FontSize',22,'Fontname','Cambria');
% 

text(t11,t8,str7,'FontSize',22,'Fontname','Cambria');
text(t11,t9,str8,'FontSize',22,'Fontname','Cambria');
text(t11,t10,str9,'FontSize',22,'Fontname','Cambria');
text(2.7,0.2,flabel,'FontSize',27,'Fontname','Cambria');
%set(gca,'xticklabel',[]);
