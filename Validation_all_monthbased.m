...
ValALLrawsm=[];
    for fold=1:3
        valmons=[springmon(fold),summermon(fold),fallmon(fold),wintermon(fold)];
        selectedFeatures = true(1, numFeatures);
        index2valid1=find(monsF==valmons(1));
        index2valid2=find(monsF==valmons(2));
        index2valid3=find(monsF==valmons(3));
        index2valid4=find(monsF==valmons(4));

        index2valids=[index2valid1;index2valid2;index2valid3;index2valid4];
...
ValALLrawsA=[];
    for fold=1:3
        ...
        valmons=[springmon(fold),summermon(fold),fallmon(fold),wintermon(fold)];
        selectedFeatures = true(1, numFeatures);
        index2valid1=find(monsA==valmons(1));
        index2valid2=find(monsA==valmons(2));
        index2valid3=find(monsA==valmons(3));
        index2valid4=find(monsA==valmons(4));
